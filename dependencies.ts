...
import * as cookie from 'https://deno.land/std@0.87.0/http/cookie.ts';
import * as http from 'https://deno.land/std@0.87.0/http/server.ts';
import * as path from 'https://deno.land/std@0.87.0/path/mod.ts';
import { Status as status, STATUS_TEXT as statusText } from 'https://deno.land/std@0.87.0/http/http_status.ts';
